...
Route::post('/loans/check-overdue', [App\Http\Controllers\LoansController::class, 'markOverdue'])->name('loans.checkOverdue');
Route::patch('/loans/{loan}/return', [App\Http\Controllers\LoansController::class, 'markAsReturned'])->name('loans.return');
